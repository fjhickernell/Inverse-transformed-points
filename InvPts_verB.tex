...
\centering
{\subfigure[$d=2,N=30$] {\includegraphics[width=5.5cm]{boxplot_d2n30.eps}}}
\quad
{\subfigure [$d=3, N=50$]
{\includegraphics[width=5.5cm]{boxplot_d3n50.eps}}}
\quad
{\subfigure[$d=4, N=70$] {\includegraphics[width=5.5cm]{boxplot_d4n70.eps}}}
\quad
{\subfigure[$d=5, N=90$] {\includegraphics[width=5.5cm]{boxplot_d5n90.eps}}}
\quad
{\subfigure[$d=6, N=110$] {\includegraphics[width=5.5cm]{boxplot_d6n110.eps}}}
\quad
{\subfigure[$d=7, N=130$] {\includegraphics[width=5.5cm]{boxplot_d7n130.eps}}}
